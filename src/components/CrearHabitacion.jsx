    ...
    <div className="bg-neutral-200 ">
      ...
      {habitacionCreadaExitosamente ? (
        ...
        <div className="alert alert-danger" role="alert">
          Ha ocurrido un error al crear la habitación. Por favor, inténtalo de
          nuevo.
          <button
            type="button"
            className="btn-close"
      ...
      <div>
        <div>
          <form action="/habitaciones/crear" method="post">
            <div>
              <label htmlhtmlFor="numeroHabitacion">
            ...
            <div>
              <label htmlhtmlFor="capacidadHabitacion">
                Capacidad de la Habitación:
              </label>
              <input
                type="number"
                id="capacidadHabitacion"
                name="capacidadHabitacion"
                required
              />
            </div>
            <div>
